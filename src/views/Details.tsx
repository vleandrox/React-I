                        ...
                        <div id="details" className={styles["columns-container"]}>
                            <section className={styles["product-images-block"]}>
                                <div className={styles["product-images"]}>
                                    <img className={styles["mini-img"]} src={product.images[1]} alt="MacBook Pro 13'4" />
                                    <img className={styles["mini-img"]} src={product.images[1]} alt="MacBook Pro 13'4" />
                                </div>
                                <img className={styles["big-img"]} id="big-img" src={product.images[0]} alt="MacBook Pro 13'4" />
                            </section>
                            ...
                            <div className={styles["product-checkout-block"]}>
                                <div className={styles["checkout-container"]}>
                                    ...
                                    <h2 id="price" className={styles["product-total-price"]}>$750000</h2>
        ...
        <main>
            <div className={styles["details-container"]}>
                <div id="details" className={styles["columns-container"]}>
                    <section className={styles["product-images-block"]}>
                        <div className={styles["product-images"]}>
                            <img className={styles["mini-img"]} src="https://i.postimg.cc/HxGQcrcp/mock1.jpg" alt="MacBook Pro 13'4" />
                            <img className={styles["mini-img"]} src="https://i.postimg.cc/Y91Q1tYQ/mock2.jpg" alt="MacBook Pro 13'4" />
                        </div>
                        <img className={styles["big-img"]} id="big-img" src="https://i.postimg.cc/HxGQcrcp/mock1.jpg" alt="MacBook Pro 13'4" />
                    </section>
                    <div className={styles["product-description-block"]}>
                ...
                <div className={styles["sales-block"]}>
                    ...
                    <div id="product-container" className={styles["product-container"]}>
                        <a className={styles["product-card"]} href="./details.html">
                            <img className={styles["product-img"]} src="https://i.postimg.cc/2ymFtsTn/kindle2.jpg" alt="Kindle Paperwhite" />
                            <div className={styles["product-info"]}>
                                ...
                                <div className={styles["product-tax-polixy"]}>
